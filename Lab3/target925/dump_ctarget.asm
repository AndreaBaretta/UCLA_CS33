...
0000000000400f90 <initialize_target>:
  ...
  400fa7:	e8 87 1b 00 00       	call   402b33 <gencookie>
  400fac:	89 05 52 35 20 00    	mov    %eax,0x203552(%rip)        # 604504 <cookie>
  400fb2:	89 c7                	mov    %eax,%edi
  400fb4:	e8 7a 1b 00 00       	call   402b33 <gencookie>
  ...
  4010ab:	00 
  4010ac:	e8 19 18 00 00       	call   4028ca <init_driver>
...
00000000004010e0 <main>:
  ...
  401176:	ff 24 c5 58 2e 40 00 	jmp    *0x402e58(,%rax,8)
  40117d:	48 8b 3b             	mov    (%rbx),%rdi
  401180:	e8 8b fd ff ff       	call   400f10 <usage>
  401185:	be ad 31 40 00       	mov    $0x4031ad,%esi
  ...
  40126f:	e8 37 07 00 00       	call   4019ab <check_fail>
  ...
  401290:	e8 c7 0b 00 00       	call   401e5c <stable_launch>
...
00000000004017a0 <getbuf>:
  ...
  4017a7:	e8 2e 02 00 00       	call   4019da <Gets>
...
00000000004017b6 <touch1>:
  ...
  4017c1:	00 00 00 
  4017c4:	bf 03 30 40 00       	mov    $0x403003,%edi
  4017c9:	e8 82 f4 ff ff       	call   400c50 <puts@plt>
  4017ce:	bf 01 00 00 00       	mov    $0x1,%edi
  4017d3:	e8 f1 03 00 00       	call   401bc9 <validate>
...
0000000000401838 <hexmatch>:
  ...
  401883:	be 20 30 40 00       	mov    $0x403020,%esi
...
000000000040191a <test>:
  ...
  40192a:	bf c8 30 40 00       	mov    $0x4030c8,%edi
...
00000000004019ab <check_fail>:
  ...
  4019cb:	e8 b0 f2 ff ff       	call   400c80 <printf@plt>
  4019d0:	bf 01 00 00 00       	mov    $0x1,%edi
  4019d5:	e8 16 f4 ff ff       	call   400df0 <exit@plt>
...
00000000004019da <Gets>:
  ...
  4019f9:	e8 42 ff ff ff       	call   401940 <save_char>
  4019fe:	48 89 eb             	mov    %rbp,%rbx
  401a01:	48 8b 3d e8 2a 20 00 	mov    0x202ae8(%rip),%rdi        # 6044f0 <infile>
  401a08:	e8 53 f3 ff ff       	call   400d60 <_IO_getc@plt>
  ...
  401a1f:	e8 74 ff ff ff       	call   401998 <save_term>
...
0000000000401a2c <notify_server>:
  ...
  401a5d:	e8 1e f2 ff ff       	call   400c80 <printf@plt>
  401a62:	bf 01 00 00 00       	mov    $0x1,%edi
  401a67:	e8 84 f3 ff ff       	call   400df0 <exit@plt>
  ...
  401ac0:	e8 1b f3 ff ff       	call   400de0 <sprintf@plt>
  ...
  401afa:	e8 94 0f 00 00       	call   402a93 <driver_post>
  ...
  401b12:	e8 69 f1 ff ff       	call   400c80 <printf@plt>
  401b17:	bf 01 00 00 00       	mov    $0x1,%edi
  401b1c:	e8 cf f2 ff ff       	call   400df0 <exit@plt>
  401b21:	bf 50 32 40 00       	mov    $0x403250,%edi
  401b26:	e8 25 f1 ff ff       	call   400c50 <puts@plt>
  401b2b:	bf 33 31 40 00       	mov    $0x403133,%edi
  401b30:	e8 1b f1 ff ff       	call   400c50 <puts@plt>
  401b35:	e9 85 00 00 00       	jmp    401bbf <notify_server+0x193>
  401b3a:	bf 3d 31 40 00       	mov    $0x40313d,%edi
  401b3f:	e8 0c f1 ff ff       	call   400c50 <puts@plt>
  ...
  401b61:	e8 1a f1 ff ff       	call   400c80 <printf@plt>
  ...
  401b77:	e8 04 f1 ff ff       	call   400c80 <printf@plt>
  ...
  401b8d:	e8 ee f0 ff ff       	call   400c80 <printf@plt>
...
0000000000401bc9 <validate>:
  ...
  401be2:	e8 69 f0 ff ff       	call   400c50 <puts@plt>
  401be7:	b8 00 00 00 00       	mov    $0x0,%eax
  401bec:	e8 ba fd ff ff       	call   4019ab <check_fail>
  ...
  401c07:	e8 74 f0 ff ff       	call   400c80 <printf@plt>
  401c0c:	b8 00 00 00 00       	mov    $0x0,%eax
  401c11:	e8 95 fd ff ff       	call   4019ab <check_fail>
  ...
  401c2e:	e8 4d f0 ff ff       	call   400c80 <printf@plt>
  ...
  401c4e:	e8 d9 fd ff ff       	call   401a2c <notify_server>
  ...
  401c68:	e8 13 f0 ff ff       	call   400c80 <printf@plt>
  401c6d:	89 de                	mov    %ebx,%esi
  401c6f:	bf 01 00 00 00       	mov    $0x1,%edi
  401c74:	e8 b3 fd ff ff       	call   401a2c <notify_server>
  401c79:	5b                   	pop    %rbx
  401c7a:	c3                   	ret
...
0000000000401c7b <fail>:
  ...
  401c8d:	e8 19 fd ff ff       	call   4019ab <check_fail>
  401c92:	89 fe                	mov    %edi,%esi
  401c94:	bf 00 00 00 00       	mov    $0x0,%edi
  401c99:	e8 8e fd ff ff       	call   401a2c <notify_server>
...
0000000000401ca3 <bushandler>:
  ...
  401cb5:	e8 96 ef ff ff       	call   400c50 <puts@plt>
  401cba:	b8 00 00 00 00       	mov    $0x0,%eax
  401cbf:	e8 e7 fc ff ff       	call   4019ab <check_fail>
  401cc4:	bf 10 33 40 00       	mov    $0x403310,%edi
  401cc9:	e8 82 ef ff ff       	call   400c50 <puts@plt>
  401cce:	bf af 31 40 00       	mov    $0x4031af,%edi
  401cd3:	e8 78 ef ff ff       	call   400c50 <puts@plt>
  401cd8:	be 00 00 00 00       	mov    $0x0,%esi
  401cdd:	bf 00 00 00 00       	mov    $0x0,%edi
  401ce2:	e8 45 fd ff ff       	call   401a2c <notify_server>
  401ce7:	bf 01 00 00 00       	mov    $0x1,%edi
  401cec:	e8 ff f0 ff ff       	call   400df0 <exit@plt>
...
0000000000401cf1 <seghandler>:
  ...
  401d03:	e8 48 ef ff ff       	call   400c50 <puts@plt>
  401d08:	b8 00 00 00 00       	mov    $0x0,%eax
  401d0d:	e8 99 fc ff ff       	call   4019ab <check_fail>
  401d12:	bf 30 33 40 00       	mov    $0x403330,%edi
  401d17:	e8 34 ef ff ff       	call   400c50 <puts@plt>
  401d1c:	bf af 31 40 00       	mov    $0x4031af,%edi
  401d21:	e8 2a ef ff ff       	call   400c50 <puts@plt>
  401d26:	be 00 00 00 00       	mov    $0x0,%esi
  401d2b:	bf 00 00 00 00       	mov    $0x0,%edi
  401d30:	e8 f7 fc ff ff       	call   401a2c <notify_server>
  401d35:	bf 01 00 00 00       	mov    $0x1,%edi
  401d3a:	e8 b1 f0 ff ff       	call   400df0 <exit@plt>
...
0000000000401d3f <illegalhandler>:
  ...
  401d51:	e8 fa ee ff ff       	call   400c50 <puts@plt>
  401d56:	b8 00 00 00 00       	mov    $0x0,%eax
  401d5b:	e8 4b fc ff ff       	call   4019ab <check_fail>
  401d60:	bf 58 33 40 00       	mov    $0x403358,%edi
  401d65:	e8 e6 ee ff ff       	call   400c50 <puts@plt>
  401d6a:	bf af 31 40 00       	mov    $0x4031af,%edi
  401d6f:	e8 dc ee ff ff       	call   400c50 <puts@plt>
  401d74:	be 00 00 00 00       	mov    $0x0,%esi
  401d79:	bf 00 00 00 00       	mov    $0x0,%edi
  401d7e:	e8 a9 fc ff ff       	call   401a2c <notify_server>
  401d83:	bf 01 00 00 00       	mov    $0x1,%edi
  401d88:	e8 63 f0 ff ff       	call   400df0 <exit@plt>
...
0000000000401ddb <launch>:
  ...
  401dfb:	e8 90 ee ff ff       	call   400c90 <memset@plt>
  ...
  401e4b:	e8 5b fb ff ff       	call   4019ab <check_fail>
  401e50:	bf 0c 32 40 00       	mov    $0x40320c,%edi
  401e55:	e8 f6 ed ff ff       	call   400c50 <puts@plt>
  401e5a:	c9                   	leave
  401e5b:	c3                   	ret
...
0000000000401e5c <stable_launch>:
  ...
  401e84:	e8 e7 ed ff ff       	call   400c70 <mmap@plt>
  ...
  401e9c:	e8 df ee ff ff       	call   400d80 <munmap@plt>
  ...
  401eb7:	e8 44 ee ff ff       	call   400d00 <fprintf@plt>
  401ebc:	bf 01 00 00 00       	mov    $0x1,%edi
  401ec1:	e8 2a ef ff ff       	call   400df0 <exit@plt>
  ...
  401eeb:	e8 eb fe ff ff       	call   401ddb <launch>
  ...
  401f02:	e8 79 ee ff ff       	call   400d80 <munmap@plt>
  401f07:	5b                   	pop    %rbx
  401f08:	c3                   	ret
...
0000000000401f22 <sigalrm_handler>:
  ...
  401f3c:	e8 bf ed ff ff       	call   400d00 <fprintf@plt>
  401f41:	bf 01 00 00 00       	mov    $0x1,%edi
  401f46:	e8 a5 ee ff ff       	call   400df0 <exit@plt>
...
0000000000401f4b <urlencode>:
  ...
  401f6d:	e9 93 00 00 00       	jmp    402005 <urlencode+0xba>
  ...
  401fde:	e8 fd ed ff ff       	call   400de0 <sprintf@plt>
...
0000000000402021 <rio_writen>:
  ...
  402042:	e8 19 ec ff ff       	call   400c60 <write@plt>
  402047:	48 85 c0             	test   %rax,%rax
  40204a:	7f 0f                	jg     40205b <rio_writen+0x3a>
  40204c:	e8 bf eb ff ff       	call   400c10 <__errno_location@plt>
...
000000000040207d <rio_read>:
  ...
  40209e:	e8 1d ec ff ff       	call   400cc0 <read@plt>
  4020a3:	89 43 04             	mov    %eax,0x4(%rbx)
  4020a6:	85 c0                	test   %eax,%eax
  4020a8:	79 0c                	jns    4020b6 <rio_read+0x39>
  4020aa:	e8 61 eb ff ff       	call   400c10 <__errno_location@plt>
  ...
  4020dc:	e8 4f ec ff ff       	call   400d30 <memcpy@plt>
...
0000000000402104 <rio_readlineb>:
  ...
  40212b:	e8 4d ff ff ff       	call   40207d <rio_read>
...
0000000000402187 <submitr>:
  ...
  4021cf:	e8 3c ec ff ff       	call   400e10 <socket@plt>
  ...
  402223:	e9 68 06 00 00       	jmp    402890 <submitr+0x709>
  402228:	4c 89 e7             	mov    %r12,%rdi
  40222b:	e8 c0 ea ff ff       	call   400cf0 <gethostbyname@plt>
  ...
  40228d:	e8 1e ea ff ff       	call   400cb0 <close@plt>
  402292:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  402297:	e9 f4 05 00 00       	jmp    402890 <submitr+0x709>
  ...
  4022d1:	e8 ba ea ff ff       	call   400d90 <bcopy@plt>
  ...
  4022f6:	e8 05 eb ff ff       	call   400e00 <connect@plt>
  ...
  402349:	e8 62 e9 ff ff       	call   400cb0 <close@plt>
  40234e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  402353:	e9 38 05 00 00       	jmp    402890 <submitr+0x709>
  ...
  40240d:	e8 9e e8 ff ff       	call   400cb0 <close@plt>
  402412:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  402417:	e9 74 04 00 00       	jmp    402890 <submitr+0x709>
  ...
  402437:	e8 0f fb ff ff       	call   401f4b <urlencode>
  ...
  4024bf:	e8 ec e7 ff ff       	call   400cb0 <close@plt>
  4024c4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  4024c9:	e9 c2 03 00 00       	jmp    402890 <submitr+0x709>
  ...
  4024f1:	e8 ea e8 ff ff       	call   400de0 <sprintf@plt>
  ...
  40251d:	e8 ff fa ff ff       	call   402021 <rio_writen>
  ...
  402586:	e8 25 e7 ff ff       	call   400cb0 <close@plt>
  40258b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  402590:	e9 fb 02 00 00       	jmp    402890 <submitr+0x709>
  402595:	89 ee                	mov    %ebp,%esi
  402597:	48 8d bc 24 20 80 00 	lea    0x8020(%rsp),%rdi
  40259e:	00 
  40259f:	e8 6c f9 ff ff       	call   401f10 <rio_readinitb>
  ...
  4025b8:	00 
  4025b9:	e8 46 fb ff ff       	call   402104 <rio_readlineb>
  ...
  402631:	e8 7a e6 ff ff       	call   400cb0 <close@plt>
  402636:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  40263b:	e9 50 02 00 00       	jmp    402890 <submitr+0x709>
  ...
  402667:	e8 04 e7 ff ff       	call   400d70 <__isoc99_sscanf@plt>
  40266c:	e9 98 00 00 00       	jmp    402709 <submitr+0x582>
  ...
  402685:	00 
  402686:	e8 79 fa ff ff       	call   402104 <rio_readlineb>
  ...
  4026fa:	e8 b1 e5 ff ff       	call   400cb0 <close@plt>
  4026ff:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  402704:	e9 87 01 00 00       	jmp    402890 <submitr+0x709>
  ...
  402747:	00 
  402748:	e8 b7 f9 ff ff       	call   402104 <rio_readlineb>
  ...
  4027ca:	e8 e1 e4 ff ff       	call   400cb0 <close@plt>
  4027cf:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  4027d4:	e9 b7 00 00 00       	jmp    402890 <submitr+0x709>
  ...
  4027fa:	e8 e1 e5 ff ff       	call   400de0 <sprintf@plt>
  4027ff:	89 ef                	mov    %ebp,%edi
  402801:	e8 aa e4 ff ff       	call   400cb0 <close@plt>
  402806:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  40280b:	e9 80 00 00 00       	jmp    402890 <submitr+0x709>
  402810:	48 8d b4 24 20 60 00 	lea    0x6020(%rsp),%rsi
  402817:	00 
  402818:	48 89 df             	mov    %rbx,%rdi
  40281b:	e8 20 e4 ff ff       	call   400c40 <strcpy@plt>
  402820:	89 ef                	mov    %ebp,%edi
  402822:	e8 89 e4 ff ff       	call   400cb0 <close@plt>
...
00000000004028a2 <init_timeout>:
  ...
  4028bc:	e8 1f e4 ff ff       	call   400ce0 <signal@plt>
  4028c1:	89 df                	mov    %ebx,%edi
  4028c3:	e8 d8 e3 ff ff       	call   400ca0 <alarm@plt>
  4028c8:	5b                   	pop    %rbx
  4028c9:	c3                   	ret
...
00000000004028ca <init_driver>:
  ...
  402964:	e9 23 01 00 00       	jmp    402a8c <init_driver+0x1c2>
  402969:	bf 90 2f 40 00       	mov    $0x402f90,%edi
  40296e:	e8 7d e3 ff ff       	call   400cf0 <gethostbyname@plt>
  ...
  4029d1:	e8 da e2 ff ff       	call   400cb0 <close@plt>
  4029d6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  4029db:	e9 ac 00 00 00       	jmp    402a8c <init_driver+0x1c2>
  ...
  402a07:	e8 84 e3 ff ff       	call   400d90 <bcopy@plt>
  ...
  402a1d:	e8 de e3 ff ff       	call   400e00 <connect@plt>
...
0000000000402a93 <driver_post>:
  ...
  402aad:	e8 ce e1 ff ff       	call   400c80 <printf@plt>
  ...
  402ae1:	bf 90 2f 40 00       	mov    $0x402f90,%edi
  402ae6:	e8 9c f6 ff ff       	call   402187 <submitr>
...
0000000000402b33 <gencookie>:
  ...
  402b37:	e8 e4 e0 ff ff       	call   400c20 <srandom@plt>
  402b3c:	e8 0f e2 ff ff       	call   400d50 <random@plt>
  402b41:	89 c3                	mov    %eax,%ebx
  402b43:	89 c7                	mov    %eax,%edi
  402b45:	e8 b7 ff ff ff       	call   402b01 <check>
...
0000000000402b60 <__libc_csu_init>:
  ...
  402b78:	55                   	push   %rbp
  402b79:	48 8d 2d 98 12 20 00 	lea    0x201298(%rip),%rbp        # 603e18 <__do_global_dtors_aux_fini_array_entry>
  402b80:	53                   	push   %rbx
  402b81:	4c 29 e5             	sub    %r12,%rbp
  402b84:	31 db                	xor    %ebx,%ebx
  402b86:	48 c1 fd 03          	sar    $0x3,%rbp
  402b8a:	48 83 ec 08          	sub    $0x8,%rsp
  402b8e:	e8 35 e0 ff ff       	call   400bc8 <_init>
  ...
  402ba9:	41 ff 14 dc          	call   *(%r12,%rbx,8)
  ...
  402bc4:	c3                   	ret
  402bc5:	90                   	nop
  402bc6:	66 2e 0f 1f 84 00 00 	cs nopw 0x0(%rax,%rax,1)
  402bcd:	00 00 00 

0000000000402bd0 <__libc_csu_fini>:
  402bd0:	f3 c3                	repz ret
